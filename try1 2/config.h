...
public:
    ...
    void setDistanceScale(double value){m_distanceScale = value;}
    void setRadiusScale(double value){m_radiusScale = value;}
    void setPhysicsStepSize(double value){ m_physicsStepSize = value;}
    void setOvercalculatePhysicsAmount(double value){ m_overcalculatePhysics = value; }
